...
from airflow.operators.sql import SQLExecuteQueryOperator # This is the line you need
...
save_raw_data_task = SQLExecuteQueryOperator(
    task_id='save_raw_data',
    conn_id='postgres_conn',
    sql="""
    COPY driven_raw.raw_batch_data TO '/opt/airflow/data/raw_data_backup.csv' WITH CSV HEADER;
    """
)
